      ...
      <div className="max-w-4xl mx-auto bg-card rounded-lg shadow-md p-8 pb-2 border border-border">
        ...
        <section className="mb-8">
          ...
          <div className="bg-accent p-4 rounded-lg border border-border">
            <p className="text-accent-foreground font-medium">
              Для бронирования оборудования необходимо знать расположение
              техники. Обязательно присутствие на ознакомительной лекции. Без
              этого доступ к бронированию и съемкам не предоставляется
            </p>
          </div>
        </section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li>
              <strong className="text-foreground">
                Бронировать минимум за 3 дня до съемок.
              </strong>{" "}
              Планируйте заранее и уважайте время других участников
            </li>
            <li>
              Если позиция занята — свяжитесь с этим человеком напрямую,
              договоритесь, напишите в описании заявки о том, что и у кого вы
              хотите взять
            </li>
          </ul>
        </section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>
                  Тщательно осмотрите состояние каждой позиции вашего
                  бронирования
                </li>
                <li>
                  Ответственность за повреждения несет последний, кто брал
                  оборудование
                </li>
                <li>
                  При обнаружении повреждений оборудования / при отсутствии
                  забронированного оборудования, сообщите об этом техническому
                  директору
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>
                  Если не можете сдать вовремя — свяжитесь с техническим
                  директором заранее
                </li>
                <li>
                  <strong className="text-foreground">
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            Если требуется срочное бронирование (день в день) — свяжитесь с
          ...
          <div className="space-y-4">
            <div className="bg-destructive/10 border-l-4 border-destructive p-4 rounded">
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground">
                ...
                <li>
                  Несвоевременная сдача оборудования без предупреждения
                  технического директора
                </li>
                <li>Повреждение оборудования</li>
                <li>Потеря оборудования</li>
                <li>
                  Порча циклорамы (разливы, загрязнения, рисунки и прочие
                  повреждения)
                </li>
              </ul>
            </div>
            ...
            <div className="bg-secondary p-4 rounded-lg border border-border">
              ...
              <p className="text-muted-foreground">
                Накопленные косяки обнуляются один раз в полгода либо после
                отбытия бана (блокировки на 2 недели)
              </p>
            </div>
          </div>
        </section>
